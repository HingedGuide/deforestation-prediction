...
class ResUnet(nn.Module):
    def __init__(self, channel, nb_classes, filters=[64, 128, 256, 512]):
        ...
        self.input_layer = nn.Sequential(
            nn.Conv2d(channel, filters[0], kernel_size=7, stride=2, padding=0),
        ...
        self.adjusting_layer = nn.Sequential(
            nn.Conv2d(filters[1], filters[1], kernel_size=3, stride=1, padding=0),
...
if __name__ == "__main__":
    model = ResUnet(channel=8, nb_classes = 8, filters=[64, 64, 64, 64])
