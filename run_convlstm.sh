...
#SBATCH --output=logs/convlstm_%j.out
#SBATCH --error=logs/convlstm_%j.err
...
# 3. Run ConvLSTM
# Note: ConvLSTM can be slower per epoch than CNNs due to the sequential loop.
python src/deforestation_predictor/training/train_experiment.py \
    ...
    --wandb_run_name "ConvLSTM_Experiment"