#!/bin/bash
#SBATCH --job-name=resunet3d_3m_100e
#SBATCH --output=logs/resunet3d_3m_100e_%j.out
#SBATCH --error=logs/resunet3d_3m_100e_%j.err
...
python src/deforestation_predictor/training/train_experiment.py \
    ...
    --wandb_run_name "ResUNet3D_3m_100e_bs32"