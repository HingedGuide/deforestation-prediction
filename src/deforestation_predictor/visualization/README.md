...
This directory contains scripts that are used for visualizing the model predictions. It can be used for small test samples, but also for full tiles for both the Deep Learning architectures and the XGBoost baseline.
...
# Key components
**1. Full-Tile Inference (`predict_tile.py`)** \
